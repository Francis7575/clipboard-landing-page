...
const Footer = () => {
    return (
        <footer className='bg-light-grayish-blue bg-opacity-10 pt-[3.25rem] pb-[3.25rem] 
                ...
                lg:pr-[5.313rem] xl:pr-[10.313rem] xl-pl[10.313rem]'>
            <div className='flex justify-center mb-[2.5rem] lg:block lg:mb-0 lg:mr-[8.438rem]'>
                <img className='max-w-[3.43rem]' src={ClipboardLogo} alt="Clipboard logo" />
            </div>
            ...
            <div className='flex justify-center items-center gap-[2.5rem] lg:gap-[1.688rem]'>
